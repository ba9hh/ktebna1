    ...
    >
      ...
      <DialogContent sx={{ textAlign: "center", pt: 3, px: 4, pb: 6 }}>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-5 py-2 bg-white/40 border border-gray-300 shadow-sm text-gray-700 hover:bg-gray-50 active:scale-95 transition duration-150 ease-in-out"
        >
          {/* Google Logo */}
          <svg
            className="w-5 h-5"
