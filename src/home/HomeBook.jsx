      ...
      <div className="px-3 pb-3">
        ...
        <div className="mt-3 space-y-3">
          ...
          <div className="flex items-center justify-between gap-1">
            ...
            <button
              className="w-1/2 flex justify-center items-center gap-1 rounded-xl border border-amber-700 py-2 text-sm font-medium text-amber-50 hover:bg-amber-800 active:scale-[0.98] "
              onClick={(e) => {
                e.stopPropagation();
                handleOpenContactDrawer();
              }}
